...
int   enter_explore_mode ()
   {
   return enter_explore_mode_ ();
   }
...
int   doprev_message ()
   {
   return doprev_message_ ();
   }

#ifdef POLYSELF
int   domonability ()
   {
   return domonability_ ();
   }

#endif                          /* POLYSELF */

int   timed_occupation ()
   {
   return timed_occupation_ ();
   }

#if defined(WIZARD) || defined(EXPLORE_MODE)
int   wiz_attributes ()
   {
   return wiz_attributes_ ();
   }
...
int   wiz_identify ()
   {
   return wiz_identify_ ();
   }
int   wiz_level_tele ()
   {
   return wiz_level_tele_ ();
   }
int   wiz_map ()
   {
   return wiz_map_ ();
...
struct obj *obj;
   {
   return in_container_ (obj);
   }
int   out_container (obj)
struct obj *obj;
   {
   return out_container_ (obj);
   }
...
void  tty_player_selection ()
   {
   tty_player_selection_ ();
   }
void  tty_askname ()
   {
   tty_askname_ ();
   }
void  tty_get_nh_event ()
   {
   tty_get_nh_event_ ();
   }
...
const char *str;
   {
   tty_exit_nhwindows_ (str);
   }
void  tty_suspend_nhwindows (str)
const char *str;
   {
   tty_suspend_nhwindows_ (str);
   }
void  tty_resume_nhwindows ()
   {
   tty_resume_nhwindows_ ();
   }
winid tty_create_nhwindow (type)
int   type;
   {
   return tty_create_nhwindow_ (type);
   }
void  tty_clear_nhwindow (window)
winid window;
   {
   tty_clear_nhwindow_ (window);
   }
...
winid window;
   {
   return tty_select_menu_ (window);
   }
void  tty_update_inventory ()
   {
   tty_update_inventory_ ();
   }
void  tty_mark_synch ()
   {
   tty_mark_synch_ ();
