...
#define STONE_LINE_CENT 28        /* char[] element of center of stone
                                 * face */
#define STONE_LINE_LEN 16        /* # chars that fit on one line (note
                                 * 1 ' ' border) */
#define NAME_LINE 6              /* *char[] line # for player name */
#define GOLD_LINE 7              /* *char[] line # for amount of gold */
#define DEATH_LINE 8              /* *char[] line # for death
                                 * description */
