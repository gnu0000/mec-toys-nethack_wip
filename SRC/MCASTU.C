 ...
 */
   ...
   switch (mattk->adtyp)
            ...
            default:           /* psi bolt */
               if (Antimagic)
                  ...
                  if (dmg <= 10)
                     ...
                     Your ("%s suddenly aches!", body_part (HEAD));
                  }
               break;
            }
         break;
      ...
      case AD_CLRC:              /* clerical spell */
         ...
         switch (rn2 ((int) mtmp->m_lev))
            {
               /* Other ideas: lightning bolts, towers of flame, gush
                * of water  -3. */
            ...
            case 9:
            case 8:              /* insects */
               /* Try for insects, and if there are none left, go for
                * (sticks to) snakes.  -3. */
                  {
                  int   i;
