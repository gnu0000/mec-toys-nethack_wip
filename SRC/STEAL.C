...
long                             /* actually returns something that
                                 * fits in an int */
      somegold ()
   {
...
register struct monst *mtmp;
   ...
   if (u.uhave.amulet)
      ...
      return;                    /* you have nothing of special
                                 * interest */
...
register struct monst *mtmp;
register int show;
boolean is_pet;                 /* If true, pet should keep
                                 * wielded/worn items */
   {
   register struct obj *otmp,
        *otmp2;
   register int omx = mtmp->mx,
         omy = mtmp->my;
   ...
   for (; otmp; otmp = otmp2)
      ...
      if (flooreffects (otmp, omx, omy, "fall"))
         continue;
