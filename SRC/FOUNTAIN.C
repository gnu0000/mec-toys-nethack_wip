...
void
   ...
   if (mons[PM_WATER_DEMON].geno & (G_GENOD | G_EXTINCT))
      return;
...
static void
   ...
   if (mons[PM_WATER_NYMPH].geno & (G_GENOD | G_EXTINCT))
      return;
...
void
      dogushforth (drinking)     /* Gushing forth along LOS from
                                 * (u.ux, u.uy) */
int   drinking;
   {
   int   madepool = 0;
...
static void
      dofindgem ()              /* Find a gem in the sparkling
                                 * waters. */
   {
   if (!Blind)
...
void
   ...
   if (fate < 10)
      ...
      switch (fate)
         ...
         case 27:              /* Find a gem in the sparkling
                                 * waters. */
...
register struct obj *obj;
   ...
   switch (rnd (30))
      ...
      case 29:                 /* You see coins */
         ...
         /* We make fountains have more coins the closer you are to
          * the surface.  After all, there will have been more people
          * going by.   Just like a shopping mall!  Chris Woodbury  */
...
void
   ...
   switch (rn2 (20))
      ...
      case 2:
         ...
         break;
      case 3:
         if (mons[PM_SEWER_RAT].geno & (G_GENOD | G_EXTINCT))
