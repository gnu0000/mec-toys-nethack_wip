...
# endif
      ...
      if (wep->cursed &&
         ...
         {
         /* The message must be printed before setuwep (since you
          * might die and be revived from changing weapons), and the
          * message must be before the death message and Lifesaved
          * rewielding.  Yet we want the message to say "weapon in
          * hand", thus this kludge. */
...
register int amount;
   ...
   /* Enchantment, which normally improves a weapon, has an addition
