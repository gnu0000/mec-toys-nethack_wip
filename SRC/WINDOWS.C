...
#endif
#ifdef AMIGA_INTUITION
   /* A shared library is used for implementing the access to these
    * two different display mechanisms.  This means that the function
    * names are actually the same (assembler stubs) and the libraries
    * do different things. */
      {
