...
int   x_maze_max,
      y_maze_max;                 /* initialized in main, used in
                                 * mkmaze.c */
...
int   ramdisk = FALSE;           /* whether to copy bones to levels or
                                 * not */
int   saveprompt = TRUE;
...
NEARDATA char **viz_array = 0;  /* used in cansee() and couldsee()
                                 * macros */
