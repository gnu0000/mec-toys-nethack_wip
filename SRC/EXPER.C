...
int
      experience (mtmp, nk)     /* return # of exp points for mtmp
                                 * after nk killed */
...
#ifdef NEW_SCORING
   /* ------- recent addition: make nr of points decrease when this
    * is not the first of this kind */
      {
