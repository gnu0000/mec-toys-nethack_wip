...
//
// GNU - naaa lets allow it
//
//      /* big rooms cannot be wand or book shops, - so make them
//       * general stores 
//       */
...
static struct mkroom *pick_room (strict)
...
static void
   ...
   sroom->rtype = TEMPLE;
   /* In temples, shrines are blessed altars located in the center of
    * the room */
...
struct mkroom *r;
   ...
   /* Well, I really should write only useful informations instead of
    * writing the whole structure. That is I should not write the
    * subrooms pointers, but who cares ? */
